...
public class HaksaServlet extends HttpServlet {
	...
	else if(command.equals("/professorList.do")) {//교수전체출력
		response.sendRedirect("professor/professorList.jsp");
	}//교수전체출력
	...
	else if(command.equals("/professorConfirm.do")) {//교수확인폼
		out.print("<style>");
		out.print("ul{list-style-type:none;}");
		out.print("</style>");
	...
	else if(command.equals("/managerRegister.do")) {//관리자등록
		String age = request.getParameter("nai");
		String irum = request.getParameter("irum");
		String part = request.getParameter("part");
		managerDTO.setNai(age);
	...
	else if(command.equals("/managerList.do")) {//관리자전체출력
		response.sendRedirect("managers/managerList.jsp");
	}//관리자전체출력	
	...
	else if(command.equals("/managerConfirm.do")) {//관리자확인폼
		out.print("<style>");
		out.print("ul{list-style-type:none;}");
		out.print("</style>");
